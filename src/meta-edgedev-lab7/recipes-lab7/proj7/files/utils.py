...
# Contains frequency values for each note type
NOTES = {
    "A": 440,
    "A#": 466.1637615180899,
    "B": 493.8833012561241,
...
# Creates a frequency spectrum of an audio signal
...
def frequency_spectrum(sample, max_frequency=800):
    ...
    freq_magnitude = np.fft.fft(raw_audio_data)  # fft computing and normalization
...
# Classifies a note based on the generated frequency array
